                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('directors.index') }}">Our Directors</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-secondary">
                            ...
                            <!-- form start -->
                            <form
                                action="{{ route("directors.update", $data) }}"
                                method="POST" 
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href={{ route("directors.index") }} class="btn btn-danger">Back</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
