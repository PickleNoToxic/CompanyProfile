                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('sosmeds.index') }}">Sosial Media</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-secondary">
                            ...
                            <!-- form start -->
                            <form
                                action="{{ route("sosmeds.update", $data) }}"
                                method="POST" 
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="photo">New Photo (200x200)</label>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href={{ route("sosmeds.index") }} class="btn btn-danger">Back</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
