                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-secondary">
                            ...
                            <!-- form start -->
                            <form
                                action="{{ route("programs.update", $data) }}"
                                method="POST" 
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="is_best">Best Program?</label>
                                                <select class="form-control @error('is_best') is-invalid @enderror" id="is_best" name="is_best" required>
                                                    <option value="">Choose a status</option>
                                                    <option value="1" {{ old('is_best', $data->is_best) == '1' ? 'selected' : '' }}>YES</option>
                                                    <option value="0" {{ old('is_best', $data->is_best) == '0' ? 'selected' : '' }}>NO</option>
                                                </select>
                                                @error('is_best')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="photo">New Photo (600x796)</label>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href={{ route("programs.index") }} class="btn btn-danger">Back</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
